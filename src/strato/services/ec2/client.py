...
class EC2Client:
    ...
    @safe_aws_call(default={}, context_key=["image_id", "ImageId"])
    ...
    @safe_aws_call(default=False, context_key=["instance_id", "InstanceId"])
    ...
    @safe_aws_call(default={}, context_key=["volume_ids"])
    ...
    @safe_aws_call(default={"Inbound": [], "Outbound": []}, context_key=["group_ids"])
